...
PREFIX_OPERATORS = {
    op.op: op for op in [
        ...
        UnaryOperator(70, '-', lambda x: -x),
        UnaryOperator(55, 'sqrt', lambda x: x.sqrt()),
        UnaryOperator(55, 'sin', lambda x: Decimal(math.sin(float(x)))),
        UnaryOperator(55, 'cos', lambda x: Decimal(math.cos(float(x)))),
        UnaryOperator(55, 'tan', lambda x: Decimal(math.tan(float(x)))),
        UnaryOperator(55, 'tg', lambda x: Decimal(math.tan(float(x)))),
        UnaryOperator(55, 'ln', lambda x: Decimal(math.log(float(x)))),
        UnaryOperator(55, 'log', lambda x: Decimal(math.log(float(x)))),
        UnaryOperator(55, 'abs', lambda x: abs(x)),
        UnaryOperator(55, 'exp', lambda x: Decimal(math.exp(float(x)))),
        UnaryOperator(55, 'asin', lambda x: Decimal(math.asin(float(x)))),
        UnaryOperator(55, 'acos', lambda x: Decimal(math.acos(float(x)))),
        UnaryOperator(55, 'atan', lambda x: Decimal(math.atan(float(x)))),
        UnaryOperator(55, 'floor', lambda x: Decimal(math.floor(float(x)))),
        UnaryOperator(55, 'ceil', lambda x: Decimal(math.ceil(float(x)))),
        UnaryOperator(55, 'deg', lambda x: Decimal(math.degrees(float(x)))),
        UnaryOperator(55, 'rad', lambda x: Decimal(math.radians(float(x)))),
    ]
}
...
SUFFIX_OPERATORS = {
    op.op: op for op in [
        ...
        UnaryOperator(54, '|>sqrt', lambda x: x.sqrt()),
        UnaryOperator(54, '|>sin', lambda x: Decimal(math.sin(float(x)))),
        UnaryOperator(54, '|>cos', lambda x: Decimal(math.cos(float(x)))),
        UnaryOperator(54, '|>tan', lambda x: Decimal(math.tan(float(x)))),
        UnaryOperator(54, '|>tg', lambda x: Decimal(math.tan(float(x)))),
        UnaryOperator(54, '|>ln', lambda x: Decimal(math.log(float(x)))),
        UnaryOperator(54, '|>log', lambda x: Decimal(math.log(float(x)))),
        UnaryOperator(54, '|>abs', lambda x: abs(x)),
        UnaryOperator(54, '|>exp', lambda x: Decimal(math.exp(float(x)))),
        UnaryOperator(54, '|>asin', lambda x: Decimal(math.asin(float(x)))),
        UnaryOperator(54, '|>acos', lambda x: Decimal(math.acos(float(x)))),
        UnaryOperator(54, '|>atan', lambda x: Decimal(math.atan(float(x)))),
        UnaryOperator(54, '|>floor', lambda x: Decimal(math.floor(float(x)))),
        UnaryOperator(54, '|>ceil', lambda x: Decimal(math.ceil(float(x)))),
        UnaryOperator(54, '|>deg', lambda x: Decimal(math.degrees(float(x)))),
        UnaryOperator(54, '|>rad', lambda x: Decimal(math.radians(float(x)))),
    ]
}
